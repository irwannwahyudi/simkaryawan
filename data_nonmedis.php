...
if (isset($_POST['cari'])) {
  $nonmedis = cari($_POST['keyword'], 'Non Medis'); // tambah 'Non Medis'
}
?>
...
<body class="w-100">
  <div class="d-flex w-100">
    ...
    <div class="flex-grow-1 pt-4 px-4">
      <div class="mb-4">
        <h2 class="dashboard-title">DATA KARYAWAN <span class="text-warning fw-bold">NON MEDIS</span></h2>
